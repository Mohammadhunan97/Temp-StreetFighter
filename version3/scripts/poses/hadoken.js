	...
	if(hadoken_enabled === true){
		if(hero_object.stamina_points >= 100){	
			...
			check_stamina(hero_object);
				...
				hero_object.me.className = hero_object.classKey + '_hadoken_main';
				hero_object.me.className +=' topdog';
					setTimeout(function(){
						hero_object.me.className += ' ' + hero_object.classKey + '_hadoken_first';
						if(hero_object.x > 300){ 
						hero_object.x = 100; 
						move_horizontal(hero_object);
						}
							setTimeout(function(){
							hero_object.me.className += ' ' + hero_object.classKey + '_hadoken_second';

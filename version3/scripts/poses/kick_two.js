...
function kick_two(hero_object){
	if(hero_object.stamina_points >=20){
		...
		hero_object.me.className = ' ' + hero_object.classKey + '_kicktwo_main';
		hero_object.me.className +=' topdog';
		setTimeout(function(){
			hero_object.me.className += ' ' + hero_object.classKey + '_kicktwo_first';
			setTimeout(function(){
				hero_object.me.className += ' ' + hero_object.classKey + '_kicktwo_second';
				setTimeout(function(){
					hero_object.me.className += ' ' + hero_object.classKey + '_kicktwo_third';
					setTimeout(function(){
